...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>PLP Project EHS (Environmental, Health & Safety) | Fire safety</title>
      <!-- Favicon  -->
              ...
              <div class="containerr">
                ...
                <div class="col-12 col-lg-8">
                    <div class="post-details-content mb-100">
                        <h3>Fire Safety</h3>                        
                        <p>                        
                        We strive to ensure the safety of our client's premises and occupants with our comprehensive fire safety solutions. 
                        From risk assessments to preventive measures and emergency preparedness, we provide expert guidance to 
                        mitigate fire risks and ensure regulatory compliance. Our services encompass thorough inspections, 
                        installation of detection and suppression systems, staff training, and ongoing monitoring to safeguard 
                        lives and property. Trust us to create a fire-safe environment, minimizing the impact of potential disasters 
                        and promoting peace of mind for all stakeholders.
                        </p>                        
                        <img class="mb-30" src="https://media.istockphoto.com/id/1963208386/photo/engineer-check-fire-suppression-system-check-fire-extinguisher-tank-in-the-fire-control-room.jpg?s=612x612&w=0&k=20&c=mLcUmT8qLRA4RWIZKxFHOJ9CHFC2ATep-6FU9-N72FM=" alt="">
                    </div>
                </div>                                         
            </div>
          </div>
